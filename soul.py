...
bot_token = '7414024203:AAGOVy3WOzcdFR9o_JDGmIRA4M8e15ma6jo'  # Replace with your bot token
...
ADMIN_ID = 1931192707  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @Zeus_God_69: {ADMIN_ID}")
